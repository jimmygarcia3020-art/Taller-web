...
CREATE TABLE IF NOT EXISTS `roles` (
  `id_rol` int NOT NULL AUTO_INCREMENT, -- MEJORA: Se agregó AUTO_INCREMENT
...
CREATE TABLE IF NOT EXISTS `proveedores` (
  `id_proveedor` int NOT NULL AUTO_INCREMENT, -- MEJORA: Se agregó AUTO_INCREMENT
  `nombre` varchar(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `productos_servicios` (
  `id_producto` int NOT NULL AUTO_INCREMENT, -- MEJORA: Se agregó AUTO_INCREMENT
  `nombre` varchar(100) NOT NULL,
  `tipo` enum('PRODUCTO','SERVICIO') NOT NULL,
  `precio` decimal(12,2) NOT NULL DEFAULT '0.00', -- MEJORA: Decimal(12,2) para mayor escala
  PRIMARY KEY (`id_producto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS `plan_cuentas` (
  `id_cuenta` int NOT NULL AUTO_INCREMENT, -- MEJORA: Se agregó AUTO_INCREMENT
...
-- MEJORA ROADMAP: Nueva tabla de categorías para clasificar finanzas
...
CREATE TABLE IF NOT EXISTS `compras` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_cliente` int DEFAULT NULL, -- MEJORA: Necesario para saber a qué cliente pertenece la compra
  `fecha` date NOT NULL,
  `doc` varchar(50) DEFAULT NULL,
  `entidad` varchar(255) DEFAULT NULL,
  `descripcion` text,
  `monto` decimal(12,2) NOT NULL DEFAULT '0.00', -- MEJORA: Decimal(12,2)
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ventas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_cliente` int DEFAULT NULL, -- MEJORA: Necesario para saber a qué cliente pertenece la venta
  `fecha` date NOT NULL,
  `doc` varchar(50) DEFAULT NULL,
  `entidad` varchar(255) DEFAULT NULL,
  `descripcion` text,
...
-- MEJORA ROADMAP: Tabla centralizada para facilitar los reportes financieros e IA
...
CREATE TABLE IF NOT EXISTS `comprobantes` (
  `id_comprobante` int NOT NULL AUTO_INCREMENT, -- MEJORA: Se agregó AUTO_INCREMENT
...
CREATE TABLE IF NOT EXISTS `detalle_comprobante` (
  `id_detalle` int NOT NULL AUTO_INCREMENT, -- MEJORA: Se agregó AUTO_INCREMENT
...
CREATE TABLE IF NOT EXISTS `pagos` (
  `id_pago` int NOT NULL AUTO_INCREMENT, -- MEJORA: Se agregó AUTO_INCREMENT
  `id_comprobante` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `asientos` (
  `id_asiento` int NOT NULL AUTO_INCREMENT, -- MEJORA: Se agregó AUTO_INCREMENT
...
CREATE TABLE IF NOT EXISTS `auditoria` (
  `id_auditoria` int NOT NULL AUTO_INCREMENT, -- MEJORA: Se agregó AUTO_INCREMENT
